...
public class ArabicUtilities {
	 ...
	 */
	private static final String FONTS_LOCATION_PATH = "fonts/othmani.ttf";
	...
	public static String getArabicNumber(String number) {
		String result = "";
		Log.v("verbose arabic number", number);
		for (int i = 0; i < number.length(); i++) {
			result += ArabicReshaper.NUMBER_GLYPH[Integer.parseInt(String
